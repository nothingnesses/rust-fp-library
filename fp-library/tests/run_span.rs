...
#[test]
fn rc_run_explicit_t1_span_produces_scoped_layer() {
	let action: RcxProg = RcRunExplicit::pure(42);
	let prog: RcxProg = RcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(Span::Span {
			..
		}))) => {}
...
#[test]
fn rc_run_explicit_t2_tag_is_stored_by_value() {
	let action: RcxProg = RcRunExplicit::pure(42);
	let prog: RcxProg = RcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(Span::Span {
...
#[test]
fn rc_run_explicit_t3_action_thunk_materialises_action_program() {
	let action: RcxProg = RcRunExplicit::pure(42);
	let prog: RcxProg = RcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(Span::Span {
...
#[test]
fn arc_run_explicit_t1_span_produces_scoped_layer() {
	let action: AcxProg = ArcRunExplicit::pure(42);
	let prog: AcxProg = ArcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(SendSpan::Span {
			..
		}))) => {}
...
#[test]
fn arc_run_explicit_t2_tag_is_stored_by_value() {
	let action: AcxProg = ArcRunExplicit::pure(42);
	let prog: AcxProg = ArcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(SendSpan::Span {
...
#[test]
fn arc_run_explicit_t3_action_thunk_materialises_action_program() {
	let action: AcxProg = ArcRunExplicit::pure(42);
	let prog: AcxProg = ArcRunExplicit::span::<String, _>("request".to_owned(), action);
	match prog.peel() {
		Err(Node::Scoped(Coproduct::Inl(SendSpan::Span {
