...
- **functions**: Inference-based free function wrappers (the primary user API). Each wrapper combines brand inference (via `InferableBrand`) with Val/Ref dispatch. Re-exports `explicit::` variants from dispatch for multi-brand types.
