...
from container types. See [hkt.md](./hkt.md).
...
See [brand-inference.md](./brand-inference.md).
...
and `optics_compose`. See [optics-analysis.md](./optics-analysis.md).
...
**Lazy evaluation and stack safety** (see [lazy-evaluation.md](./lazy-evaluation.md)):
...
**Free functors** (see [coyoneda.md](./coyoneda.md)):
...
See [pointer-abstraction.md](./pointer-abstraction.md).
