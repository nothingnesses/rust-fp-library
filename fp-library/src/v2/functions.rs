...
///
/// ```rust
/// use fp_library::v2::functions::compose;
///
...
///
/// ```rust
/// use fp_library::v2::functions::constant;
///
/// assert_eq!(
///     constant(true)(false),
///     true
...
///
/// ```rust
/// use fp_library::v2::functions::flip;
///
...
///
/// ```rust
/// use fp_library::v2::functions::identity;
///
/// assert_eq!(
///     identity(()),
///     ()
