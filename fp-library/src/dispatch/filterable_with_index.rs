...
//!
//! - [`FilterWithIndexDispatch`] + [`filter_with_index`]
//! - [`FilterMapWithIndexDispatch`] + [`filter_map_with_index`]
//! - [`PartitionWithIndexDispatch`] + [`partition_with_index`]
//! - [`PartitionMapWithIndexDispatch`] + [`partition_map_with_index`]
//!
