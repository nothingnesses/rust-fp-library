...
#[doc = "[`BrandN` trait][crate::hkt::brands] for [types][crate::types] with kind `*`."]
pub trait Brand0<Concrete>
where
	Self: Kind<()>,
{
	fn inject(a: Concrete) -> Apply<Self, ()>;
...
impl<Me, Concrete> Brand<Concrete, ()> for Me
where
	Me: Kind<()> + Brand0<Concrete>,
{
	fn inject(a: Concrete) -> Apply<Self, ()> {
		<Me as Brand0<Concrete>>::inject(a)
	}
	fn project(a: Apply<Self, ()>) -> Concrete {
		<Me as Brand0<Concrete>>::project(a)
	}
}
#[doc = "[`BrandN` trait][crate::hkt::brands] for [types][crate::types] with kind `* -> *`."]
