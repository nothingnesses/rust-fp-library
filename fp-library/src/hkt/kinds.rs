...
//! * `Kind_L1_T1_B0l0_Ol0`: 1 lifetime, 1 type. Type 0 is bounded by Lifetime 0 (`A: 'a`). Output is bounded by Lifetime 0 (`Output: 'a`).
...
* The resulting associated output type is constrained by the lifetime: `Output: 'a` (`Ol0` in the name).
"
);
