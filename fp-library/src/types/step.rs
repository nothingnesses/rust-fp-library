...
mod inner {
	...
	impl_kind! {
		impl<LoopType> for StepWithLoopBrand<LoopType> {
			type Of<B> = Step<LoopType, B>;
		}
	}

	#[document_type_parameters("The loop type.")]
	impl<LoopType> Functor for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> Lift for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType> Pointed for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> ApplyFirst for StepWithLoopBrand<LoopType> {}

	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> ApplySecond for StepWithLoopBrand<LoopType> {}

	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> Semiapplicative for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> Semimonad for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType> Foldable for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType: Clone> Traversable for StepWithLoopBrand<LoopType> {
	...
	#[document_type_parameters("The loop type.")]
	impl<LoopType> ParFoldable for StepWithLoopBrand<LoopType> {
	...
	impl_kind! {
		impl<DoneType> for StepWithDoneBrand<DoneType> {
			type Of<A> = Step<A, DoneType>;
		}
	}

	#[document_type_parameters("The done type.")]
	impl<DoneType> Functor for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> Lift for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType> Pointed for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> ApplyFirst for StepWithDoneBrand<DoneType> {}

	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> ApplySecond for StepWithDoneBrand<DoneType> {}

	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> Semiapplicative for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> Semimonad for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType> Foldable for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType: Clone> Traversable for StepWithDoneBrand<DoneType> {
	...
	#[document_type_parameters("The done type.")]
	impl<DoneType> ParFoldable for StepWithDoneBrand<DoneType> {
