//! Named Fail helpers layered over the Run wrapper primitives.
//!
//! Fail runners interpret the fixed-message aborting effect into
//! `Result<A, String>`. Fail remains a distinct row identity from
//! `ExceptBrand<String>` so APIs can choose between a fixed-message
//! failure channel and typed exception handling.
