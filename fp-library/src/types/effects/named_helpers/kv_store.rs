//! Named KVStore helpers layered over the Run wrapper primitives.
//!
//! The standard runner interprets lookup and update operations with a
//! `std::collections::BTreeMap`, returning the program result together
//! with the final map.
