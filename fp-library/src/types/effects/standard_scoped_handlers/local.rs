...
mod inner {
	...
	/// Handler for the standard `Local` scoped effect.
	///
	...
	/// Raw scoped dispatch implementation for the Rc-backed Local handler.
	#[document_type_parameters(
		"The first-order row brand.",
		"The scoped row brand.",
		"The final program result type.",
	...
	/// Raw scoped dispatch implementation for the Arc-backed Local handler.
	#[document_type_parameters(
		"The first-order row brand.",
		"The scoped row brand.",
		"The final program result type.",
