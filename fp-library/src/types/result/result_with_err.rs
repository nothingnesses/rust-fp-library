	...
	for<'a> E: 'a,
{
	...
	///
	/// assert_eq!(
	///     bind::<RcFnBrand, ResultWithErrBrand<_>, _, _>(Err(()))(Rc::new(pure::<ResultWithErrBrand<_>, ()>)),
	///     Err(())
	/// );
	/// assert_eq!(
	///     bind::<RcFnBrand, ResultWithErrBrand<()>, _, _>(Ok(()))(Rc::new(pure::<ResultWithErrBrand<_>, _>)),
	///     Ok(())
	/// );
	/// ```
