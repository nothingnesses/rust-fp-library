...
///
/// The supertraits are:
/// * [`Applicative`]: which combines [`Functor`][crate::typeclasses::Functor],
///   [`Pure`][crate::typeclasses::Pure], [`Apply`][crate::typeclasses::Apply],
///   [`ApplyFirst`][crate::typeclasses::ApplyFirst],
///   and [`ApplySecond`][crate::typeclasses::ApplySecond].
/// * [`Bind`]: for sequencing computations where the second depends on the result of the first.
