...
/// ```
pub fn get<F, A>(a: &Apply!(F, Once, (), (A))) -> Option<&A>
where
	F: Once,
{
	F::get(a)
...
/// ```
pub fn get_mut<F, A>(a: &mut Apply!(F, Once, (), (A))) -> Option<&mut A>
where
	F: Once,
{
	F::get_mut(a)
...
/// ```
pub fn into_inner<F, A>(a: Apply!(F, Once, (), (A))) -> Option<A>
where
	F: Once,
{
	F::into_inner(a)
...
/// ```
pub fn take<F, A>(a: &mut Apply!(F, Once, (), (A))) -> Option<A>
where
	F: Once,
{
	F::take(a)
