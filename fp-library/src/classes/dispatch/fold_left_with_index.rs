//! Dispatch for [`FoldableWithIndex::fold_left_with_index`](crate::classes::FoldableWithIndex::fold_left_with_index) and
//! [`RefFoldableWithIndex::ref_fold_left_with_index`](crate::classes::RefFoldableWithIndex::ref_fold_left_with_index).
//!
//! Provides the [`FoldLeftWithIndexDispatch`] trait and a unified [`fold_left_with_index`] free function
...
//! };
//!
//! // By-value fold_left_with_index (Vec)
...
//!
//! // By-ref fold_left_with_index (Lazy, closure receives &A)
