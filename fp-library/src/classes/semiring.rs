		...
		($($t:ty),+) => {
			$(
				impl Semiring for $t {
					...
					#[document_examples(skip_call_check, reason = "This primitive impl is generated by macro_rules! and its doctest body is assembled with #[doc = concat!(...)]; document_examples runs before that generated doc text exists, so direct-call validation cannot see the generated method call.")]
					///
					/// ```
