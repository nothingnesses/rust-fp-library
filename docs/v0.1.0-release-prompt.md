...
Before making changes and periodically during implementation, track your progress:
...
4. **Formulate commit message**: Output a summary for the user to use in the git commit
...
1. Review all changes: `git diff HEAD~N` (where N is number of commits)
2. Commit any remaining changes
3. Tag the release: `git tag v0.1.0`
4. Push: `git push && git push --tags`
5. Publish: `cargo publish -p fp-library`
```
