...
| `Span<'a, Tag>`                         | `tag: Tag`, `action: Run<R, S, A>`                                                                                                                            | Instrumentation / tracing. User-facing Val-only operation; implementation stores action via per-pointer B-thunks per B21. |
