...
- **Plan-text amendment.** [`fp-library/src/types/effects/bracket.rs`](../../../fp-library/src/types/effects/bracket.rs) (lands in step 3.3.1) ships with `BoxBracket::acquire: Box<dyn 'a + FnOnce(()) -> Run<R, S, A>>`, `Bracket::acquire: Rc<dyn 'a + Fn(()) -> Run<R, S, A>>`, `SendBracket::acquire: Arc<dyn 'a + Fn(()) -> Run<R, S, A> + Send + Sync>` (all per-pointer-brand B-thunks). Same pattern in [`fp-library/src/types/effects/ref_bracket.rs`](../../../fp-library/src/types/effects/ref_bracket.rs) (lands in step 3.3.5).
