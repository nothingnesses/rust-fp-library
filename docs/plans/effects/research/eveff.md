...
This design introduces a **sixth category deserving Stage 2 deep-dive**. While the type-level structure resembles option 1, the evidence-passing dispatch is a qualitatively different approach to effect row representation and operation invocation. Key implications for the port-plan:
