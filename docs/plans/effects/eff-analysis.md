...
The recommended path remains: use `eff`'s semantics and handler API as design targets while implementing via a free-monad-based approach (closer to `purescript-run`). See [decisions.md](./decisions.md) for the proposed Rust design.
