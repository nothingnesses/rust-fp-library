...
Phase 3 closes with step 8; Phase 3.5 sub-steps 1 and 2 have
shipped. The next concrete work is **Phase 3.5 sub-step 3**
(update [`pointer-abstraction.md`](file:///home/jessea/Documents/projects/rust-fp-lib/fp-library/docs/pointer-abstraction.md)
to add `ToDynFnOnce` to the trait diagram and the
brand-implementations table), followed by sub-steps 4-5
(integration-test verification follow-up, F4-closure resolutions
entry), then Phase 4 implementation.
