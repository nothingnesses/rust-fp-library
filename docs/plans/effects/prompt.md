...
Phase 3 closes with step 8; Phase 3.5 sub-steps 1, 2, and 3 have
shipped (sub-step 4 is implicit). The next concrete work is
**Phase 3.5 sub-step 5** (append a
[resolutions.md](file:///home/jessea/Documents/projects/rust-fp-lib/docs/plans/effects/resolutions.md)
entry documenting the F4 closure structurally rather than as
accepted-tradeoff), then Phase 4 implementation.
