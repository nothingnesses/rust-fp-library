...
**Step 3.3.4** (Bracket Val integration tests): ~22 shape-only
tests at `fp-library/tests/run_bracket.rs` (file lands in this
step) mirroring [run_local.rs](file:///home/jessea/Documents/projects/rust-fp-lib/fp-library/tests/run_local.rs)'s
