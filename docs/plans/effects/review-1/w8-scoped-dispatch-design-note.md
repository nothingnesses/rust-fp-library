...
- The scoped row `S` holds higher-order, around-action effects (`Catch`,
  ...
  `Functor::map`. See
  [`scoped.rs`](../../../../fp-library/src/types/effects/scoped.rs).
...
- `DispatchScopedHandlers` walks the scoped-handler cons-list against the
  ...
  [`interpreter.rs` cons-cell impl](../../../../fp-library/src/types/effects/interpreter.rs)
  (`dispatch_scoped`).
...
[`scoped_resume.rs`](../../../../fp-library/src/types/effects/interpreter/scoped_resume.rs)
...
- The erased wrappers (`Run`, `RcRun`, `ArcRun`) keep the pending `Free`
  ...
  [`run/representation.rs`](../../../../fp-library/src/types/effects/run/representation.rs),
  [`rc_run/raw_scoped.rs`](../../../../fp-library/src/types/effects/rc_run/raw_scoped.rs),
  [`arc_run/raw_scoped.rs`](../../../../fp-library/src/types/effects/arc_run/raw_scoped.rs).
- The explicit wrappers (`RunExplicit`, `RcRunExplicit`,
  `ArcRunExplicit`) carry a typed boundary value. See
  [`run_explicit/boundary.rs`](../../../../fp-library/src/types/effects/run_explicit/boundary.rs),
  [`rc_run_explicit/boundary.rs`](../../../../fp-library/src/types/effects/rc_run_explicit/boundary.rs),
  [`arc_run_explicit/boundary.rs`](../../../../fp-library/src/types/effects/arc_run_explicit/boundary.rs).
