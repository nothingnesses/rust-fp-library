...
* **Parallelization and Thread Safety (Rayon Support)** — See [Thread Safety and Parallelism](limitations.md#thread-safety-and-parallelism) for detailed analysis of the issue and proposed solutions.
