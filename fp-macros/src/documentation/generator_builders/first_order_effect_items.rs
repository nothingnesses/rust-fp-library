...
pub(super) fn choose_effect_items_tokens() -> TokenStream {
	...
	let send_clone_examples = document_examples_with_lines(&[
		"",
		" ```",
		" use {",
		" \tfp_library::{",
	...
	let boxed_map_examples = document_examples_with_lines(&[
		"",
		" ```",
		" use fp_library::{",
		" \tbrands::*,",
...
pub(super) fn empty_effect_items_tokens() -> TokenStream {
	let clone_examples = document_examples_with_lines(&[
		"",
		" ```",
		" use {",
	...
	let default_examples = document_examples_with_lines(&[
		"",
		" ```",
